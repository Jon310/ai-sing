        ...
        public static Composite CreatePaladinProtectionCombatBuffs()
        {
            return
                new PrioritySelector(
                    ...
                    Spell.BuffSelf("Word of Glory", ret => StyxWoW.Me.HealthPercent < 75 && StyxWoW.Me.CurrentHolyPower == 3 || StyxWoW.Me.HealthPercent < 75 && StyxWoW.Me.ActiveAuras.ContainsKey("Divine Purpose")),
