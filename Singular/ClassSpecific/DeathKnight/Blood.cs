            ...
            return
                ...
                // spread the disease around.
                            ...
                            Spell.Cast("Death Strike", ret =>
                                 StyxWoW.Me.UnholyRuneCount >= 1 && StyxWoW.Me.DeathRuneCount >= 1 ||
                                 StyxWoW.Me.FrostRuneCount >= 1 && StyxWoW.Me.DeathRuneCount >= 1 ||
                                 StyxWoW.Me.UnholyRuneCount >= 1 && StyxWoW.Me.FrostRuneCount >= 1 ||
                                 StyxWoW.Me.DeathRuneCount >= 2),

                            Spell.Cast("Blood Boil", ret =>
                                 StyxWoW.Me.HasAura("Crimson Scourge")),

                            Spell.Cast("Blood Boil", ret => _nearbyUnfriendlyUnits.Count >= Settings.BloodBoilCount && StyxWoW.Me.BloodRuneCount >= 1),

                            Spell.Cast("Heart Strike", ret => _nearbyUnfriendlyUnits.Count < Settings.BloodBoilCount && StyxWoW.Me.BloodRuneCount >= 1),
                            
                            Spell.Cast("Rune Strike", ret=>
                                StyxWoW.Me.CurrentRunicPower >= 76),
