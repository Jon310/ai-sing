    ...
    public class Unholy
    {
        ...
        public static Composite CreateDeathKnightUnholyNormalCombat()
        {
            return new PrioritySelector(
                ...
                Spell.Cast("Death Coil", ret => Common.BestDeathcoilTarget, ret => TalentManager.HasGlyph("Death Coil")),
        ...
        public static Composite CreateDeathKnightUnholyPvPCombat()
        {
            return new PrioritySelector(
                ...
                Spell.Cast("Death Coil",
                           ret =>
                           StyxWoW.Me.HasAura(SuddenDoom) || StyxWoW.Me.CurrentRunicPower >= 80),
                Spell.Cast("Death Coil", ret => StyxWoW.Me.Pet, ret => StyxWoW.Me.Pet.HealthPercent < 60),
