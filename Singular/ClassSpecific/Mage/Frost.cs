    ...
    public class Frost
    {
        ...
        public static Composite CreateMageFrostNormalPull()
        {
            return new PrioritySelector(
                ...
                Spell.Cast("Frostfire Bolt", ret => StyxWoW.Me.HasAura("Brain Freeze")),
        ...
        public static Composite CreateMageFrostNormalCombat()
        {
            return new PrioritySelector(
                ...
                Spell.Cast("Spellsteal",
                      ret => StyxWoW.Me.CurrentTarget.HasAura("Ancient Magic")),
                 Spell.Cast("Frozen Orb", ret => Unit.UnfriendlyUnitsNearTarget(10f).Count() >= 1),
                 Spell.Cast("Frost Bomb", ret => Unit.UnfriendlyUnitsNearTarget(10f).Count() >= 0),
                 ...
                 Spell.Cast("Fire Blast",
                     ret => StyxWoW.Me.CurrentTarget.HasAura("Frost Bomb")),
                 new Decorator(
        ...
        public static Composite CreateMageFrostPvPPullAndCombat()
        {
            return new PrioritySelector(
                ...
                // Cooldowns
                 ...
                 Spell.Cast("Presence of Mind"),
                 Spell.Cast("Spellsteal",
                      ret => StyxWoW.Me.CurrentTarget.HasAura("Ancient Magic") && !StyxWoW.Me.CurrentTarget.HasAura("Deep Freeze")),
                 Spell.Cast("Frozen Orb", ret => Unit.UnfriendlyUnitsNearTarget(10f).Count() >= 1),
                 Spell.Cast("Frost Bomb", ret => Unit.UnfriendlyUnitsNearTarget(10f).Count() >= 0),
                 Spell.Cast("Deep Freeze",
                     ret => StyxWoW.Me.ActiveAuras.ContainsKey("Fingers of Frost") ||
